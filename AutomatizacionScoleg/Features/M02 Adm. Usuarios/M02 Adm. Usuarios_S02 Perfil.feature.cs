...
#line hidden
        ...
        public virtual void CP03_EditarPerfil(string descripcionSearch, string grupo, string descripcionEdit, string grupoEdit, string[] exampleTags)
        {
...
#line 25
 testRunner.And(string.Format("El sistema despliega el formulario para editar perfil y con la siguiente informac" +
                        "ión: descripción {0}, grupo {1}", descripcionSearch, grupo), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Y ");
#line 26
